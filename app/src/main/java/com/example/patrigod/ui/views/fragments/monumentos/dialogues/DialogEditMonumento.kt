...
class DialogEditMonumento(
    ...
    private val ARGUMENT_DES_PLUS: String = ArgumentsMonumento.ARGUMENT_DES_PLUS
    private val ARGUMENT_ID: String = ArgumentsMonumento.ARGUMENT_ID
    init {
        /*
        Preparo el Bundle para pasárselo al Dialog.
        */
        val args = Bundle().apply {
            putString(ARGUMENT_ID, monumentoToUpdate.id.toString())
