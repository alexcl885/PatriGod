...
class GetMonumentoByPosUseCase @Inject constructor(private val monumentoRepository: MonumentoRepository) {
    suspend operator fun invoke(pos:Int): Monumento? = monumentoRepository.getMonumentoByPos(pos)
}